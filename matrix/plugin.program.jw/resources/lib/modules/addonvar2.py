...
class Addonvar:
    ...
    def add_whitelist(self, _excludes):
        import json
        if xbmcvfs.exists(self.whitelist_path):
            with open(self.whitelist_path, 'r') as wl:
    ...
    def EXCLUDES(self):
        ...
        return self.add_whitelist(excludes)